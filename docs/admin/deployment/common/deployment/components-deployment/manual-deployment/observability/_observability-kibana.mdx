...
If infrastructure logging is enabled, you can access historical infrastructure logs in **Discover** section.

:::note Metrics Index
The `codemie_metrics_logs` data view for user metrics is automatically configured during [Kibana Dashboards](#kibana-dashboards-installation) installation.
:::
